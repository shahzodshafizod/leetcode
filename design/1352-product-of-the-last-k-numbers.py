    ...
    def test(self):
        for commands, values, expected in [
            ...
            (
                ...
                [None,None,None,None,None,50,None,None,None,None,None,0,None,0,None,70,7,None,None,None,None],
            ),
            (
            ...
            (
                ...
                [None,None,None,None,None,18,None,0,None,None,None,84,None,84,None,168,None,1344,64,1344,1344],
            ),
            (
