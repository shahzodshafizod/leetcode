...
// // Space: O(N)
// func countPairs(root *TreeNode, distance int) int {
// 	var adjList = make(map[*TreeNode][]*TreeNode)
// 	var buildGraph func(parent *TreeNode, node *TreeNode)
// 	buildGraph = func(parent *TreeNode, node *TreeNode) {
// 		if node == nil {
// 			return
// 		}
// 		if parent != nil {
...
// 	var countPairs func(node *TreeNode, dist int, visited map[*TreeNode]bool) int
// 	countPairs = func(node *TreeNode, dist int, visited map[*TreeNode]bool) int {
...
// 		if node.Left == nil && node.Right == nil {
// 			pairs += countPairs(node, 0, make(map[*TreeNode]bool)) - 1 // O(N)
// 		}
// 	}
