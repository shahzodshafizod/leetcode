...
class Solution(unittest.TestCase):
    ...
    def test(self):
        for edges, bob, amount, expected in [
            ...
            ([[0,2],[1,4],[1,6],[2,4],[3,6],[3,7],[5,7]], 4, [-6896,-1216,-1208,-1108,1606,-7704,-9212,-8258], -34998),
            ([[0,2],[1,4],[1,6],[2,3],[2,8],[3,7],[4,5],[6,7]], 1, [-1410,-9440,5536,-774,3044,7924,-2122,-1192,9166], 14320),
        ]:
