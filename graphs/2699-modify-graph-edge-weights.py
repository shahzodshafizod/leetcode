...
class Solution(unittest.TestCase):
    ...
    def testModifiedGraphEdges(self) -> None:
        for n, edges, source, destination, target, expected in [
            ...
            (4, [[0,1,-1],[2,0,2],[3,2,6],[2,1,10],[3,0,-1]], 1, 3, 12, [[0,1,11],[2,0,2],[3,2,6],[2,1,10],[3,0,1]]),
            (5, [[1,4,1],[2,4,-1],[3,0,2],[0,4,-1],[1,3,10],[1,0,10]], 0, 2, 15, [[1,4,1],[2,4,4],[3,0,2],[0,4,14],[1,3,10],[1,0,10]]),
            (5, [[0,2,5],[2,1,-1],[2,4,3],[3,4,5],[4,0,1],[0,3,-1],[2,3,-1]], 0, 1, 9, [[0,2,5],[2,1,5],[2,4,3],[3,4,5],[4,0,1],[0,3,7],[2,3,3]]),
        ]:
