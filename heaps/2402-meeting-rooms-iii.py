...
# python3 -m unittest heaps/2402-meeting-rooms-iii.py
...
class Solution(unittest.TestCase):
    ...
    def mostBooked(self, n: int, meetings: List[List[int]]) -> int:
        ...
        meetings.sort()
        used = []  # (end, room)
        available = [room for room in range(n)]  # sorted array is a valid heap
