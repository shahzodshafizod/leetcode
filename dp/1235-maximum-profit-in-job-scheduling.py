from bisect import bisect_right, bisect_left  # pylint: disable=unused-import
...
class Solution(unittest.TestCase):
    ...
    def test(self):
        for startTime, endTime, profit, expected in [
            ...
            (
                [8882, 7030, 7842, 8505, 8586, 2257, 8970, 1669, 1124, 3159],
                [18708, 10088, 7955, 9997, 9173, 4828, 13306, 5053, 1380, 8825],
