...
# python3 -m unittest dp/0689-maximum-sum-of-3-non-overlapping-subarrays.py
...
class Solution(unittest.TestCase):
    ...
    #     def dp(idx: int, quota: int) -> tuple[int, List[int]]:
    #         if idx+k > n or quota == 0:
    #             return 0, []
    #         if memo[idx][quota] != None:
    #             return memo[idx][quota]
    #         include, inids = dp(idx+k, quota-1)
    #         include += sums[idx]
    #         inids = [idx] + inids
    #         skip, skids = dp(idx+1, quota)
    #         if include >= skip:
    #             memo[idx][quota] = include, inids
    #         else:
    #             memo[idx][quota] = skip, skids
    #         return memo[idx][quota]
    #     return dp(0, 3)[1]
